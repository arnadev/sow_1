const navItems = {
    english: {
        home: { text: "Home", link: "/" },
        order: { text: "Order", link: "/order" },
        customers: { text: "Our Customers", link: "/customers" },
    ...
    swedish: {
        home: { text: "Hem", link: "/" },
        order: { text: "Beställ", link: "/order" },
        customers: { text: "Våra Kunder", link: "/customers" },
        about: { text: "Om Oss", link: "/about" },
        contact: { text: "Kontakta Oss", link: "/contact" },
