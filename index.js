const navItems = {
    english: {
        ...
        order: { text: "Order", link: "/bestall.html" },
    ...
    swedish: {
        ...
        order: { text: "Beställ", link: "/bestall.html" },
